...
PSE['Li']= np.array([3, 6.941, 1.715e-10, 0.05766])
PSE['Na']= np.array([11, 22.98977, 2.497e-10, 0.078226 ])
PSE['K'] = np.array([19, 39.0983, 3.184e-10, 0.1183])
PSE['Rb']= np.array([37, 85.4678, 3.302e-10, 0.2405])
PSE['Cs']= np.array([55, 132.90545, 3.440e-10, 0.5013])
...
PSE['F'] = np.array([9, 18.984032, 3.954e-10, 0.006465])
PSE['Cl']= np.array([17, 35.45, 4.612e-10, 0.02502])
PSE['Br']= np.array([35, 79.904, 4.812e-10, 0.03596])
PSE['I'] = np.array([53, 126.90447, 5.197e-10,0.04220])
